...
tree_snippy_folder= "data/genomes_analysis/tree/sepidermidis_GCF_000007645.1_ASM764v1_genomic_paperfinal/"
reference="data/genomes/reference/sepidermidis/GCF_000007645.1_ASM764v1_genomic.fa"
...
rule run_pe_snippy:
    input:
         ...
         ref=reference
    output:
        vcf = tree_snippy_folder+"snippy/{run}/snps.vcf",
        csv = tree_snippy_folder+"snippy/{run}/snps.csv",
    threads: 4
